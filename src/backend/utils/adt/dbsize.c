...
{
	const RelFileLocator zero = {0, 0, 0};
	...
	if (smgrexists(smgropen(*rfn, backend, relpersistence), forknum))
	{
		BlockNumber n = smgrnblocks(smgropen(*rfn, backend, relpersistence), forknum);
