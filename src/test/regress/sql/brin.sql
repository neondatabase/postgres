...
INSERT INTO brin_test SELECT x/100,x%100 FROM scaled_series(1,10000) x(x);
...
WITH rand_value AS (SELECT string_agg(fipshash(i::text),'') AS val FROM scaled_series(1,60) s(i))
