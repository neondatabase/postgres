...
INSERT INTO brin_test SELECT x/100,x%100 FROM generate_series(1,1000000) x(x);
...
WITH rand_value AS (SELECT string_agg(fipshash(i::text),'') AS val FROM generate_series(1,6000) s(i))
