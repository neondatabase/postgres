...
INSERT INTO brin_large_range SELECT i FROM scaled_series(1,10000) s(i);
...
INSERT INTO brin_test_multi SELECT x/100,x%100 FROM scaled_series(1,10000) x(x);
...
INSERT INTO brin_timestamp_test
SELECT i FROM scaled_series('2000-01-01'::timestamp, '2000-02-09'::timestamp, '1 day'::interval) s(i);
...
INSERT INTO brin_interval_test SELECT (i || ' years')::interval FROM scaled_series(-178000000, -177999980) s(i);

INSERT INTO brin_interval_test SELECT (i || ' years')::interval FROM scaled_series( 177999980,  178000000) s(i);
