...
insert into btree_bpchar select 'foo' from scaled_series(1,1500);
...
INSERT INTO dedup_unique_test_table SELECT i FROM scaled_series(0,450) i;
...
from scaled_series(1, 130) g;

--
-- Test for multilevel page deletion
--
CREATE TABLE delete_test_table (a bigint, b bigint, c bigint, d bigint);
INSERT INTO delete_test_table SELECT i, 1, 2, 3 FROM scaled_series(1,80000) i;
...
INSERT INTO delete_test_table SELECT i, 1, 2, 3 FROM scaled_series(1,1000) i;
