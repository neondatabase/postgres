...
CREATE TABLE default_expr_agg (a int DEFAULT (scaled_series(1,3)));
...
CREATE TABLE part_bogus_expr_fail PARTITION OF list_parted FOR VALUES IN (scaled_series(4, 6));
...
CREATE TABLE part_bogus_expr_fail PARTITION OF range_parted
  FOR VALUES FROM (scaled_series(1, 3)) TO ('2019-01-01');
