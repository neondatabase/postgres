...
SELECT * FROM scaled_series(1,10) id;
...
INSERT INTO T SELECT * FROM scaled_series(1, 10) a;
...
FROM scaled_series(1,20) q;

ALTER TABLE t1 ADD COLUMN c text;

SELECT a,
       stddev(cast((SELECT sum(1) FROM scaled_series(1,20) x) AS float4))
