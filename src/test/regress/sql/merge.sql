...
INSERT INTO pa_source SELECT id, id * 10  FROM generate_series(1,1400) AS id;
-- insert a few rows in the target table (odd numbered tid)
INSERT INTO pa_target SELECT id, id * 100, 'initial' FROM generate_series(1,150,2) AS id;
...
INSERT INTO pa_source SELECT id, id * 10  FROM generate_series(1,1400) AS id;
-- insert a few rows in the target table (odd numbered tid)
INSERT INTO pa_target SELECT '2017-01-31', id, id * 100, 'initial' FROM generate_series(1,90,3) AS id;
INSERT INTO pa_target SELECT '2017-02-28', id, id * 100, 'initial' FROM generate_series(2,90,3) AS id;
