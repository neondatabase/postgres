...
insert into test_multirange_gist select int4multirange(int4range(g, g+10),int4range(g+20, g+30),int4range(g+40, g+50)) from scaled_series(1,2000) g;
insert into test_multirange_gist select '{}'::int4multirange from scaled_series(1,500) g;
insert into test_multirange_gist select int4multirange(int4range(g, g+10000)) from scaled_series(1,1000) g;
insert into test_multirange_gist select int4multirange(int4range(NULL, g*10, '(]'), int4range(g*10, g*20, '(]')) from scaled_series(1,100) g;
insert into test_multirange_gist select int4multirange(int4range(g*10, g*20, '(]'), int4range(g*20, NULL, '(]')) from scaled_series(1,100) g;
