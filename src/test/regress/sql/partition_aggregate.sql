...
INSERT INTO pagg_tab SELECT i % 20, i % 30, to_char(i % 12, 'FM0000'), i % 30 FROM scaled_series(0, 2999) i;
ANALYZE pagg_tab;
...
INSERT INTO pagg_tab1 SELECT i % 30, i % 20 FROM scaled_series(0, 299, 2) i;
INSERT INTO pagg_tab2 SELECT i % 20, i % 30 FROM scaled_series(0, 299, 3) i;
...
INSERT INTO pagg_tab_m SELECT i % 30, i % 40, i % 50 FROM scaled_series(0, 2999) i;
ANALYZE pagg_tab_m;
...
INSERT INTO pagg_tab_ml SELECT i % 30, i % 10, to_char(i % 4, 'FM0000') FROM scaled_series(0, 29999) i;
ANALYZE pagg_tab_ml;
...
INSERT INTO pagg_tab_para SELECT i % 30, i % 20 FROM scaled_series(0, 29999) i;
