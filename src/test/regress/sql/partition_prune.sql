...
insert into list_part select generate_series(1,4000);
...
insert into lprt_a select 0 from generate_series(1,100000);
...
insert into ma_test select x,x from generate_series(0,2999) t(x);
...
from
  generate_series(0,100) a,
  generate_series(0,100) b,
  generate_Series(0,100) c,
  generate_Series(0,100) d;
