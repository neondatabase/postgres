...
begin
  ...
  create temp table temptable as select * from generate_series(1,300000) as f1;
...
insert into test_mode select 1 from generate_series(1,10000000) union all select 2;
