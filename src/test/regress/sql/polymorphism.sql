...
select first_el_agg_f8(x::float8) from scaled_series(1,10) x;
select first_el_agg_any(x) from scaled_series(1,10) x;
select first_el_agg_f8(x::float8) over(order by x) from scaled_series(1,10) x;
select first_el_agg_any(x) over(order by x) from scaled_series(1,10) x;
