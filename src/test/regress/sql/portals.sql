...
rollback;
begin;
explain (costs off) declare c2 cursor for select generate_series(1,3000) as g;
explain (costs off) declare c2 scroll cursor for select generate_series(1,3000) as g;
declare c2 scroll cursor for select generate_series(1,3000) as g;
fetch all in c2;
...
insert into toasted_data
  select array_agg(i) from generate_series(12345678, 12345678 + 100000) i;
