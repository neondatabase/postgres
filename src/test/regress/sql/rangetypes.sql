...
insert into test_range_gist select int4range(g, g+10) from scaled_series(1,2000) g;
insert into test_range_gist select 'empty'::int4range from scaled_series(1,500) g;
insert into test_range_gist select int4range(g, g+10000) from scaled_series(1,1000) g;
insert into test_range_gist select 'empty'::int4range from scaled_series(1,500) g;
insert into test_range_gist select int4range(NULL,g*10,'(]') from scaled_series(1,100) g;
insert into test_range_gist select int4range(g*10,NULL,'(]') from scaled_series(1,100) g;
insert into test_range_gist select int4range(g, g+10) from scaled_series(1,2000) g;
...
insert into test_range_spgist select int4range(g, g+10) from scaled_series(1,2000) g;
insert into test_range_spgist select 'empty'::int4range from scaled_series(1,500) g;
insert into test_range_spgist select int4range(g, g+10000) from scaled_series(1,1000) g;
insert into test_range_spgist select 'empty'::int4range from scaled_series(1,500) g;
insert into test_range_spgist select int4range(NULL,g*10,'(]') from scaled_series(1,100) g;
insert into test_range_spgist select int4range(g*10,NULL,'(]') from scaled_series(1,100) g;
insert into test_range_spgist select int4range(g, g+10) from scaled_series(1,2000) g;
...
insert into test_range_elem select i from scaled_series(1,100) i;
