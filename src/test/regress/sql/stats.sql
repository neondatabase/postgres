...
CREATE table stats_test_tab1 as select generate_series(1,1000) a;
...
INSERT INTO test_io_shared SELECT i FROM generate_series(1,10000)i;
SELECT pg_stat_force_next_flush();
...
INSERT INTO test_io_local SELECT generate_series(1, 500000) as id, repeat('a', 200);
...
INSERT INTO test_io_vac_strategy SELECT i, i from generate_series(1, 450000)i;
...
CREATE TABLE test_io_bulkwrite_strategy AS SELECT i FROM generate_series(1,10000)i;
SELECT pg_stat_force_next_flush();
...
INSERT INTO brin_hot SELECT *, 0 FROM generate_series(1, 23500);
...
INSERT INTO brin_hot_3 SELECT 1, repeat(' ', 500) FROM generate_series(1, 2000);
