...
INSERT INTO ab1 SELECT a, a%23 FROM scaled_series(1, 1000) a;
...
INSERT INTO stxdinh SELECT mod(a,50), mod(a,100) FROM scaled_series(0, 1999) a;
INSERT INTO stxdinh1 SELECT mod(a,100), mod(a,100) FROM scaled_series(0, 999) a;
INSERT INTO stxdinh2 SELECT mod(a,100), mod(a,100) FROM scaled_series(0, 999) a;
...
INSERT INTO stxdinp SELECT 1, a/100, a/100 FROM scaled_series(1, 999) a;
...
INSERT INTO functional_dependencies (a, b, c, filler1)
     SELECT mod(i, 5), mod(i, 7), mod(i, 11), i FROM scaled_series(1,1000) s(i);
...
INSERT INTO functional_dependencies (a, b, c, filler1)
     SELECT i, i, i, i FROM scaled_series(1,5000) s(i);
...
INSERT INTO functional_dependencies (a, b, c, filler1)
     SELECT mod(i,100), mod(i,50), mod(i,25), i FROM scaled_series(1,5000) s(i);
...
INSERT INTO mcv_lists (a, b, c, filler1)
     SELECT mod(i,37), mod(i,41), mod(i,43), mod(i,47) FROM scaled_series(1,5000) s(i);
...
INSERT INTO mcv_lists (a, b, c, filler1)
     SELECT i, i, i, i FROM scaled_series(1,1000) s(i);
...
TRUNCATE mcv_lists;
INSERT INTO mcv_lists (a, b, c) SELECT 1, 2, 3 FROM scaled_series(1,1000) s(i);
ANALYZE mcv_lists;
...
INSERT INTO mcv_lists_bool (a, b, c)
     ...
     FROM scaled_series(1,10000) s(i);
...
INSERT INTO expr_stats SELECT mod(i,10), mod(i,10), mod(i,10) FROM scaled_series(1,1000) s(i);
ANALYZE expr_stats;
...
INSERT INTO expr_stats SELECT mod(i,10), fipshash(mod(i,10)::text), fipshash(mod(i,10)::text) FROM scaled_series(1,1000) s(i);
ANALYZE expr_stats;
...
INSERT INTO tststats.priv_test_tbl
     SELECT mod(i,5), mod(i,10) FROM scaled_series(1,100) s(i);
...
insert into stts_t1 select i,i from scaled_series(1,100) i;
analyze stts_t1;
