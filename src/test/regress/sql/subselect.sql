...
SELECT *, pg_typeof(f1) FROM
  (SELECT 'foo' AS f1 FROM generate_series(1,30000)) ss ORDER BY 1;
...
select * from int4_tbl o where (f1, f1) in
  (select f1, generate_series(1,5000000) / 10 g from int4_tbl i group by f1);
select * from int4_tbl o where (f1, f1) in
  (select f1, generate_series(1,5000000) / 10 g from int4_tbl i group by f1);
...
declare c1 scroll cursor for
 select * from generate_series(1,400000) i
