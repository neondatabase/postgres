...
INSERT INTO base_tbl SELECT i, 'Row ' || i FROM generate_series(-2, 20) g(i);
...
CREATE VIEW ro_view12 AS SELECT * FROM generate_series(1, 100) AS g(a); -- SRF in rangetable
...
INSERT INTO base_tbl_child SELECT * FROM generate_series(1, 80);
...
INSERT INTO ref_tbl SELECT * FROM generate_series(1,100);
...
INSERT INTO t1
SELECT i,i,'t1' FROM generate_series(1,100) g(i);
ANALYZE t1;

CREATE TABLE t11 (d text) INHERITS (t1);
CREATE INDEX t11_a_idx ON t11(a);
INSERT INTO t11
SELECT i,i,'t11','t11d' FROM generate_series(1,100) g(i);
ANALYZE t11;

CREATE TABLE t12 (e int[]) INHERITS (t1);
CREATE INDEX t12_a_idx ON t12(a);
INSERT INTO t12
SELECT i,i,'t12','{1,2}'::int[] FROM generate_series(1,100) g(i);
ANALYZE t12;

CREATE TABLE t111 () INHERITS (t11, t12);
CREATE INDEX t111_a_idx ON t111(a);
INSERT INTO t111
SELECT i,i,'t111','t111d','{1,1,1}'::int[] FROM generate_series(1,100) g(i);
ANALYZE t111;
